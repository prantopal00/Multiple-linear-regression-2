    ...
    if upload_file is not None:
        ...
        if wish:
            ...
            if choise=='Mean_Standard Deviation and Percentile Method':
                ...
                # upper_limit=min(float(upper_limit0),Q4)
                # lower_limit=max(float(lower_limit0),Q1)

                upper_limit=min(float(upper_limit0),float(Q4))
                lower_limit=max(float(lower_limit0[col]),float(Q1))

                df00_nonzero=df00[df00[col]!=0]
                ...
                if wish=="Mean Standard Deviation Method":
                    ...
                    if st.checkbox("**Concider Mean and Standard Deviation as a Upper and Lower Limit**"):
                        ...
                        df00[col]=df00[col].replace(0,mean)
                        ...
                        wish= st.selectbox("**Want to replace Outlier by :**",["Percntile_Upper_Lower Limit","Mean","Median"])
                        if wish=="Percntile_Upper_Lower Limit":
                        ...
                        if wish=="Mean":
                            ...
                            df00[col] = np.where(df00[col]> upper_limit0, mean,
                            np.where(df00[col]< lower_limit0, mean,
                                df00[col]))
                        ...
                        if wish=="Median":
                            ...
                            df00[col] = np.where(df00[col]> upper_limit0, median,
                            np.where(df00[col]< lower_limit0, median,
                                df00[col]))
            ...
            if choise=='IQR Method':
                ...
                if col:
                    ...
                    if st.checkbox("**Want to replace Outlier**"):
                        ...
                        wish= st.selectbox("**Want to replace Outlier by :**",["IQR Lower_Upper Limit","Mean","Median"])
                        if wish=="IQR Lower_Upper Limit":
                            df00[col] = np.where(df00[col]> upper_limit, upper_limit,
                            np.where(df00[col]< lower_limit, lower_limit,
                            df00[col]))
                        ...
                        if wish=="Mean":
                            ...
                            df00[col] = np.where(df00[col]> upper_limit, mean,
                            np.where(df00[col]< lower_limit, mean,
                                df00[col]))
                        ...
                        if wish=="Median":
                            ...
                            df00[col] = np.where(df00[col]> upper_limit, median,
                            np.where(df00[col]< lower_limit, median,
                                df00[col]))
