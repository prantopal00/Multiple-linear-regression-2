...
if choice:
    ...
    if upload_file is not None:
        ...
        if wish:
            ...
            choise=st.selectbox("**Select One Method**",['None','Mean and Standard Deviation Method','IQR Method','Winsorize Method'])

            if choise=='None':
                pass                                         
            if choise=='Mean and Standard Deviation Method':
                df00=df
                ...
                #only keep rows in dataframe that have values within 1.5*IQR of Q1 and Q3
                    df= df00[~((df00[col]< lower_limit) | (df00[col]> upper_limit)).any(axis=1)]
